...
for i in range(1,31):
    aprendiz.append(input(f"Ingrese el nombre del aprendiz {i}: "))
    edad.append(int(input(f"Ingrese la edad de aprendiz {i}: ")))

#se imprimen las listas
print(f"Lista de aprendices: {aprendiz}")
...
if datoBuscar in aprendiz:
    print(f"{datoBuscar} esta en la lista de aprendices.")
else:
    print(f"{datoBuscar} no esta en la lista de aprendices.")
